...
**Last benchmarked at**: _Jun 28, 2026, 4:31 AM_ (_daily_ updated).
...
| install | ✔ | ✔ |   | 7s | 2.4s | 615ms | 5.4s | 1.1s |
| install |   |   | ✔ | 1.3s | 476ms | 78ms | 6.3s | n/a |
| install | ✔ |   | ✔ | 1.3s | 432ms | 78ms | 6.3s | n/a |
| install |   | ✔ | ✔ | 1s | 400ms | 92ms | 4.6s | n/a |
| install | ✔ | ✔ | ✔ | 1s | 394ms | 42ms | 4.5s | n/a |
| update | n/a | n/a | n/a | 5.5s | 6.7s | 2.1s | 5.1s | 2.3s |

<img alt="Graph of the alotta-files results" src="/img/benchmarks/alotta-files.svg?v=dd42c238" />
...
<img alt="Graph comparing pnpm versions on the alotta-files fixture" src="/img/benchmarks/alotta-files-pnpm.svg?v=8ef837d3" />